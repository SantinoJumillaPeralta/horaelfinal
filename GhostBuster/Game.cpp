...
void Game::ShowGameOverScreen()
{
	...
	if (_lifes > 0)
	{
		_txtResult.setString("You capture all enemies!");		
	}
...
{
	_window = new RenderWindow(VideoMode(780, 438), "Ghost Buster");
...
void Game::InitSound()
{
	...
	_sbHit.loadFromFile("Sounds/Terror.wav");
